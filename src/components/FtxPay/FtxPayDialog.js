...
import { abbreviateAddress, toUrlParams } from '../../utils/utils';
...
export default function FtxPayDialog({ open, onClose }) {
  ...
  const onSubmit = () =>
    window.open(
      `https://ftx.com/pay/request?${toUrlParams({
        address,
        coin,
        wallet: 'sol',
  ...
  return (
    <DialogForm open={open} onClose={onClose} fullWidth>
      ...
      <DialogContent>
        <DialogContentText>
          Log in to or create an FTX account, and send funds from it to your
          Sollet wallet: {address}.
        </DialogContentText>
