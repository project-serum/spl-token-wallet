  ...
  txInstructions.forEach((instructions) => {
    instructions.forEach((instruction) => {
      if (!instruction) {
        ...
        } else if (['MangoInitMarginAccount', 'MangoDeposit', 'MangoWithdraw',
          'MangoBorrow', 'MangoSettleBorrow', 'MangoDepositSrm', 'MangoWithdrawSrm',
          'MangoPlaceOrder', 'MangoSettleFunds', 'MangoCancelOrder', ].includes(instruction.type)) {
